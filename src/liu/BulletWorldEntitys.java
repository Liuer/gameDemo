...
public class BulletWorldEntitys<T extends BulletEntity> implements Disposable{
	public static abstract class Constructor<T extends BulletEntity> implements Disposable {
